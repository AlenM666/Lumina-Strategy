          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 rounded-xl" data-aos="fade-up">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Ana Moors</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0"></a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 rounded-xl" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Anastasia Chung</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0"></a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 rounded-xl" data-aos="fade-up" data-aos-delay="400">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Sara Rig</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0"></a>
              </div>
            </div>
